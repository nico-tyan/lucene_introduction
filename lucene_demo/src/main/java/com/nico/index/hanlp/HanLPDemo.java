...
public class HanLPDemo {
	...
	public void BZ() throws IOException{
		String text = "3月15日，邮储银行临澧县新安镇支行关爱留守儿童——“邮爱相伴，爱驻童心”";
	 ...
	 */
	@Test
	public void ZDY() throws IOException{
...
//		}
	...
	public void ZDZY(){
		String document = "算法可大致分为基本算法、数据结构的算法、数论算法、计算几何的算法、图的算法、动态规划以及数值分析、加密算法、排序算法、检索算法、随机化算法、并行算法、厄米变形模型、随机森林算法。\n" +
			...
			List<String> sentenceList = HanLP.extractSummary(document, 4);
		...
		List<Pinyin> convertToPinyinFirstCharString = HanLP.convertToPinyinList(text);
		for (Pinyin pinyin : convertToPinyinFirstCharString) {
	...
	public void ZZTJ(){
		...
		System.out.println(suggester.suggest("发言", 3));       // 语义
		System.out.println(suggester.suggest("危机公共", 3));   // 字符
		System.out.println(suggester.suggest("mayun", 3));      // 拼音
	}
}
